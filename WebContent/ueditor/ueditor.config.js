...
(function () {
    ...
    /**
     * 缂栬緫鍣ㄨ祫婧愭枃浠舵牴璺緞銆傚畠鎵�〃绀虹殑鍚箟鏄細浠ョ紪杈戝櫒瀹炰緥鍖栭〉闈负褰撳墠璺緞锛屾寚鍚戠紪杈戝櫒璧勬簮鏂囦欢锛堝嵆dialog绛夋枃浠跺す锛夌殑璺緞銆�     * 閴翠簬寰堝鍚屽鍦ㄤ娇鐢ㄧ紪杈戝櫒鐨勬椂鍊欏嚭鐜扮殑绉嶇璺緞闂锛屾澶勫己鐑堝缓璁ぇ瀹朵娇鐢�鐩稿浜庣綉绔欐牴鐩綍鐨勭浉瀵硅矾寰�杩涜閰嶇疆銆�     * "鐩稿浜庣綉绔欐牴鐩綍鐨勭浉瀵硅矾寰�涔熷氨鏄互鏂滄潬寮�ご鐨勫舰濡�/myProject/ueditor/"杩欐牱鐨勮矾寰勩�
    ...
    window.UEDITOR_CONFIG = {
        ...
        //宸ュ叿鏍忎笂鐨勬墍鏈夌殑鍔熻兘鎸夐挳鍜屼笅鎷夋锛屽彲浠ュ湪new缂栬緫鍣ㄧ殑瀹炰緥鏃堕�鎷╄嚜宸遍渶瑕佺殑閲嶆柊瀹氫箟
        , toolbars: [[
        ...
        //濡傛灉鑷畾涔夛紝鏈�ソ缁檖鏍囩濡備笅鐨勮楂橈紝瑕佷笉杈撳叆涓枃鏃讹紝浼氭湁璺冲姩鎰�        //,initialStyle:'p{line-height:1em}'//缂栬緫鍣ㄥ眰绾х殑鍩烘暟,鍙互鐢ㄦ潵鏀瑰彉瀛椾綋绛�
        //,iframeCssUrl: URL + '/themes/iframe.css' //缁欑紪杈戝尯鍩熺殑iframe寮曞叆涓�釜css鏂囦欢
        ...
        //,autoSyncData:true //鑷姩鍚屾缂栬緫鍣ㄨ鎻愪氦鐨勬暟鎹�        //,emotionLocalization:false //鏄惁寮�惎琛ㄦ儏鏈湴鍖栵紝榛樿鍏抽棴銆傝嫢瑕佸紑鍚纭繚emotion鏂囦欢澶逛笅鍖呭惈瀹樼綉鎻愪緵鐨刬mages琛ㄦ儏鏂囦欢澶�
        ...
        //insertorderedlist
        //鏈夊簭鍒楄〃鐨勪笅鎷夐厤缃�鍊肩暀绌烘椂鏀寔澶氳瑷�嚜鍔ㄨ瘑鍒紝鑻ラ厤缃�锛屽垯浠ユ鍊间负鍑�        //,'insertorderedlist':{
        //      //鑷畾鐨勬牱寮�        //        'num':'1,2,3...',
        //        'num1':'1),2),3)...',
        //        'num2':'(1),(2),(3)...',
        //        'cn':'涓�浜�涓�...',
        ...
        //insertunorderedlist
        //鏃犲簭鍒楄〃鐨勪笅鎷夐厤缃紝鍊肩暀绌烘椂鏀寔澶氳瑷�嚜鍔ㄨ瘑鍒紝鑻ラ厤缃�锛屽垯浠ユ鍊间负鍑�        //,insertunorderedlist : { //鑷畾鐨勬牱寮�        //    'dash' :'鈥�鐮存姌鍙�, //-鐮存姌鍙�        //    'dot':' 銆�灏忓渾鍦�, //绯荤粺鑷甫
        //    'circle' : '',  // '鈼�灏忓渾鍦�
        //    'disc' : '',    // '鈼�灏忓渾鐐�
        //    'square' : ''   //'鈻�灏忔柟鍧�
        //}
        ...
        //fontfamily
        //瀛椾綋璁剧疆 label鐣欑┖鏀寔澶氳瑷�嚜鍔ㄥ垏鎹紝鑻ラ厤缃紝鍒欎互閰嶇疆鍊间负鍑�        //,'fontfamily':[
        ...
        //customstyle
        //鑷畾涔夋牱寮忥紝涓嶆敮鎸佸浗闄呭寲锛屾澶勯厤缃�鍗冲彲鏈�悗鏄剧ず鍊�        //block鐨勫厓绱犳槸渚濇嵁璁剧疆娈佃惤鐨勯�杈戣缃殑锛宨nline鐨勫厓绱犱緷鎹瓸IU鐨勯�杈戣缃�        //灏介噺浣跨敤涓�簺甯哥敤鐨勬爣绛�        //鍙傛暟璇存槑
        ...
        //,contextMenu:[
        //    {
        //        label:'',       //鏄剧ず鐨勫悕绉�        //        cmdName:'selectall',//鎵ц鐨刢ommand鍛戒护锛屽綋鐐瑰嚮杩欎釜鍙抽敭鑿滃崟鏃�        //        //exec鍙�锛屾湁浜唀xec灏变細鍦ㄧ偣鍑绘椂鎵ц杩欎釜function锛屼紭鍏堢骇楂樹簬cmdName
        //        exec:function () {
        ...
        //,wordCountMsg:''   //褰撳墠宸茶緭鍏�{#count} 涓瓧绗︼紝鎮ㄨ繕鍙互杈撳叆{#leave} 涓瓧绗�        //瓒呭嚭瀛楁暟闄愬埗鎻愮ず  鐣欑┖鏀寔澶氳瑷�嚜鍔ㄥ垏鎹紝鍚﹀垯鎸夋閰嶇疆鏄剧ず
        ...
        //    textAlign:"left",               //娈佃惤鐨勬帓鐗堟柟寮忥紝鍙互鏄�left,right,center,justify 鍘绘帀杩欎釜灞炴�琛ㄧず涓嶆墽琛屾帓鐗�        //    imageBlockLine: 'center',       //鍥剧墖鐨勬诞鍔ㄦ柟寮忥紝鐙崰涓�鍓т腑,宸﹀彸娴姩锛岄粯璁� center,left,right,none 鍘绘帀杩欎釜灞炴�琛ㄧず涓嶆墽琛屾帓鐗�        //    pasteFilter: false,             //鏍规嵁瑙勫垯杩囨护娌′簨绮樿创杩涙潵鐨勫唴瀹�        //    clearFontSize: false,           //鍘绘帀鎵�湁鐨勫唴宓屽瓧鍙凤紝浣跨敤缂栬緫鍣ㄩ粯璁ょ殑瀛楀彿
        //    clearFontFamily: false,         //鍘绘帀鎵�湁鐨勫唴宓屽瓧浣擄紝浣跨敤缂栬緫鍣ㄩ粯璁ょ殑瀛椾綋
        //    removeEmptyNode: false,         // 鍘绘帀绌鸿妭鐐�        //    //鍙互鍘绘帀鐨勬爣绛�        //    removeTagNames: {鏍囩鍚嶅瓧:1},
        //    indent: false,                  // 琛岄缂╄繘
        ...
        //iframeUrlMap
        //dialog鍐呭鐨勮矾寰�锝炰細琚浛鎹㈡垚URL,鍨撳睘鎬т竴鏃︽墦寮�紝灏嗚鐩栨墍鏈夌殑dialog鐨勯粯璁よ矾寰�        //,iframeUrlMap:{
        //    'anchor':'~/dialogs/anchor/anchor.html',
        //}

        //allowLinkProtocol 鍏佽鐨勯摼鎺ュ湴鍧�紝鏈夎繖浜涘墠缂�殑閾炬帴鍦板潃涓嶄細鑷姩娣诲姞http
		...
		// xss 杩囨护鏄惁寮�惎,inserthtml绛夋搷浣�		,xssFilterRules: true
		//input xss杩囨护
		,inputXssFilter: true
		//output xss杩囨护
